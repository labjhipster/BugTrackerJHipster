...
import es.labj.bugtracker.config.Constants;
import es.labj.bugtracker.domain.User;
import es.labj.bugtracker.repository.UserRepository;
import es.labj.bugtracker.security.AuthoritiesConstants;
import es.labj.bugtracker.service.MailService;
import es.labj.bugtracker.service.UserService;
import es.labj.bugtracker.service.dto.AdminUserDTO;
import es.labj.bugtracker.web.rest.errors.BadRequestAlertException;
import es.labj.bugtracker.web.rest.errors.EmailAlreadyUsedException;
import es.labj.bugtracker.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link es.labj.bugtracker.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>

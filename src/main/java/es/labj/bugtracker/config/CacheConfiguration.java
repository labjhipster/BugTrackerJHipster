...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, es.labj.bugtracker.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, es.labj.bugtracker.repository.UserRepository.USERS_BY_EMAIL_CACHE);

...
describe('Comment Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Comment query and add missing value', () => {
      ...
      const child: IComment = { id: 25492 };
      comment.child = child;

      const commentCollection: IComment[] = [{ id: 25492 }];
    ...
    it('Should update editForm', () => {
      ...
      expect(comp.commentsSharedCollection).toContainEqual(child);
      expect(comp.usersSharedCollection).toContainEqual(login);

...
import static es.labj.bugtracker.domain.CommentAsserts.*;
...
import es.labj.bugtracker.repository.CommentRepository;
...
class CommentResourceIT {
    ...
    public static Comment createEntity() {
        return new Comment().date(DEFAULT_DATE).text(DEFAULT_TEXT);
    }
    ...
    public static Comment createUpdatedEntity() {
        return new Comment().date(UPDATED_DATE).text(UPDATED_TEXT);
    }
